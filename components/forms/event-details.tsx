...
const EventDetailsStep = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios.post("/api/event-requirements", data, {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <button
              ...
              className={`border rounded-xl py-4 text-sm sm:text-base font-medium transition
                ${
                  hireType === item.value
        ...
        {hireType === "planner" && (
          <div className="space-y-4">
            ...
            <select
              ...
              onChange={(e) =>
                setPlannerDetails({ scope: e.target.value })
              }
              className="w-full rounded-lg border px-4 py-3 sm:py-2.5"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input
                ...
                onChange={(e) =>
                  setPlannerDetails({ budgetMin: e.target.value })
                }
                className="rounded-lg border px-4 py-3 sm:py-2.5"
              />
              <input
                placeholder="Max Budget"
                value={plannerDetails.budgetMax}
                onChange={(e) =>
                  setPlannerDetails({ budgetMax: e.target.value })
                }
                className="rounded-lg border px-4 py-3 sm:py-2.5"
              />
            </div>
            ...
            <input
              ...
              onChange={(e) =>
                setPlannerDetails({ theme: e.target.value })
              }
              className="w-full rounded-lg border px-4 py-3 sm:py-2.5"
            />
          </div>
        ...
        {hireType === "performer" && (
          <div className="space-y-4">
            ...
            <input
              ...
              onChange={(e) =>
                setPerformerDetails({ genre: e.target.value })
              }
              className="w-full rounded-lg border px-4 py-3 sm:py-2.5"
            />
        ...
        {hireType === "crew" && (
          <div className="space-y-4">
            ...
            <select
              ...
              onChange={(e) =>
                setCrewDetails({ crewType: e.target.value })
              }
              className="w-full rounded-lg border px-4 py-3 sm:py-2.5"
            >
            ...
            <input
              ...
              onChange={(e) =>
                setCrewDetails({ count: e.target.value })
              }
              className="w-full rounded-lg border px-4 py-3 sm:py-2.5"
            />
            ...
            <input
              ...
              onChange={(e) =>
                setCrewDetails({ hours: e.target.value })
              }
              className="w-full rounded-lg border px-4 py-3 sm:py-2.5"
            />
            ...
            <input
              ...
              onChange={(e) =>
                setCrewDetails({ budget: e.target.value })
              }
              className="w-full rounded-lg border px-4 py-3 sm:py-2.5"
            />
          </div>
