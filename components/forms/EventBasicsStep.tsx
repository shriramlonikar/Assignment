...
const EventBasicsStep = ({ onNext }: { onNext: () => void }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-blue-100 px-4 sm:px-6">
      <button
      ...
      <div className="max-w-xl sm:max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-6 sm:p-8 space-y-6 sm:space-y-8">
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            onChange={(e) => setEventBasics({ eventName: e.target.value })}
            required
            className="w-full rounded-lg border border-gray-300 px-4 py-3 sm:py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            onChange={(e) => setEventBasics({ eventType: e.target.value })}
            required
            className="w-full rounded-lg border border-gray-300 px-4 py-3 sm:py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={() => setEventBasics({ dateType: "range" })}
                className="accent-blue-600"
              />
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <input
              ...
              onChange={(e) => setEventBasics({ city: e.target.value })}
              required
              className="rounded-lg border border-gray-300 px-4 py-3 sm:py-2.5 focus:ring-2 focus:ring-blue-500"
            />
            <input
              type="text"
              placeholder="State"
              value={eventBasics.state}
              onChange={(e) => setEventBasics({ state: e.target.value })}
              required
              className="rounded-lg border border-gray-300 px-4 py-3 sm:py-2.5 focus:ring-2 focus:ring-blue-500"
            />
            <input
              ...
              onChange={(e) => setEventBasics({ country: e.target.value })}
              required
              className="rounded-lg border border-gray-300 px-4 py-3 sm:py-2.5 focus:ring-2 focus:ring-blue-500"
            />
          </div>
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            onChange={(e) => setEventBasics({ venue: e.target.value })}
            className="w-full rounded-lg border border-gray-300 px-4 py-3 sm:py-2.5 focus:ring-2 focus:ring-blue-500"
          />
        </div>
